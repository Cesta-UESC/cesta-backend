...
func newAuxiliarPrecos(db *gorm.DB, opts ...gen.DOOption) auxiliarPrecos {
	...
	_auxiliarPrecos.auxiliarPrecosDo.UseModel(&model.AuxiliarPrecos{})
...
type IAuxiliarPrecosDo interface {
	...
	Create(values ...*model.AuxiliarPrecos) error
	CreateInBatches(values []*model.AuxiliarPrecos, batchSize int) error
	Save(values ...*model.AuxiliarPrecos) error
	First() (*model.AuxiliarPrecos, error)
	Take() (*model.AuxiliarPrecos, error)
	Last() (*model.AuxiliarPrecos, error)
	Find() ([]*model.AuxiliarPrecos, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.AuxiliarPrecos, err error)
	FindInBatches(result *[]*model.AuxiliarPrecos, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.AuxiliarPrecos) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.AuxiliarPrecos, error)
	FirstOrCreate() (*model.AuxiliarPrecos, error)
	FindByPage(offset int, limit int) (result []*model.AuxiliarPrecos, count int64, err error)
...
func (a auxiliarPrecosDo) Create(values ...*model.AuxiliarPrecos) error {
	if len(values) == 0 {
		return nil
	}
...
func (a auxiliarPrecosDo) CreateInBatches(values []*model.AuxiliarPrecos, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a auxiliarPrecosDo) Save(values ...*model.AuxiliarPrecos) error {
	if len(values) == 0 {
		return nil
	}
...
func (a auxiliarPrecosDo) First() (*model.AuxiliarPrecos, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.AuxiliarPrecos), nil
	}
}

func (a auxiliarPrecosDo) Take() (*model.AuxiliarPrecos, error) {
...
func (a auxiliarPrecosDo) Last() (*model.AuxiliarPrecos, error) {
...
func (a auxiliarPrecosDo) Find() ([]*model.AuxiliarPrecos, error) {
	result, err := a.DO.Find()
	return result.([]*model.AuxiliarPrecos), err
}

func (a auxiliarPrecosDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.AuxiliarPrecos, err error) {
	buf := make([]*model.AuxiliarPrecos, 0, batchSize)
...
func (a auxiliarPrecosDo) FindInBatches(result *[]*model.AuxiliarPrecos, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a auxiliarPrecosDo) FirstOrInit() (*model.AuxiliarPrecos, error) {
...
func (a auxiliarPrecosDo) FirstOrCreate() (*model.AuxiliarPrecos, error) {
...
func (a auxiliarPrecosDo) FindByPage(offset int, limit int) (result []*model.AuxiliarPrecos, count int64, err error) {
...
func (a auxiliarPrecosDo) Delete(models ...*model.AuxiliarPrecos) (result gen.ResultInfo, err error) {
