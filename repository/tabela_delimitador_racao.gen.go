...
func newDelimitadorRacao(db *gorm.DB, opts ...gen.DOOption) delimitadorRacao {
	...
	_delimitadorRacao.delimitadorRacaoDo.UseModel(&model.DelimitadorRacao{})
...
type IDelimitadorRacaoDo interface {
	...
	Create(values ...*model.DelimitadorRacao) error
	CreateInBatches(values []*model.DelimitadorRacao, batchSize int) error
	Save(values ...*model.DelimitadorRacao) error
	First() (*model.DelimitadorRacao, error)
	Take() (*model.DelimitadorRacao, error)
	Last() (*model.DelimitadorRacao, error)
	Find() ([]*model.DelimitadorRacao, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.DelimitadorRacao, err error)
	FindInBatches(result *[]*model.DelimitadorRacao, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.DelimitadorRacao) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.DelimitadorRacao, error)
	FirstOrCreate() (*model.DelimitadorRacao, error)
	FindByPage(offset int, limit int) (result []*model.DelimitadorRacao, count int64, err error)
...
func (d delimitadorRacaoDo) Create(values ...*model.DelimitadorRacao) error {
	if len(values) == 0 {
		return nil
	}
...
func (d delimitadorRacaoDo) CreateInBatches(values []*model.DelimitadorRacao, batchSize int) error {
	return d.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (d delimitadorRacaoDo) Save(values ...*model.DelimitadorRacao) error {
	if len(values) == 0 {
		return nil
	}
...
func (d delimitadorRacaoDo) First() (*model.DelimitadorRacao, error) {
	if result, err := d.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.DelimitadorRacao), nil
	}
}

func (d delimitadorRacaoDo) Take() (*model.DelimitadorRacao, error) {
...
func (d delimitadorRacaoDo) Last() (*model.DelimitadorRacao, error) {
...
func (d delimitadorRacaoDo) Find() ([]*model.DelimitadorRacao, error) {
	result, err := d.DO.Find()
	return result.([]*model.DelimitadorRacao), err
}

func (d delimitadorRacaoDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.DelimitadorRacao, err error) {
	buf := make([]*model.DelimitadorRacao, 0, batchSize)
...
func (d delimitadorRacaoDo) FindInBatches(result *[]*model.DelimitadorRacao, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (d delimitadorRacaoDo) FirstOrInit() (*model.DelimitadorRacao, error) {
...
func (d delimitadorRacaoDo) FirstOrCreate() (*model.DelimitadorRacao, error) {
...
func (d delimitadorRacaoDo) FindByPage(offset int, limit int) (result []*model.DelimitadorRacao, count int64, err error) {
...
func (d delimitadorRacaoDo) Delete(models ...*model.DelimitadorRacao) (result gen.ResultInfo, err error) {
