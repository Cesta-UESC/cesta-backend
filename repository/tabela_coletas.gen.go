...
func newColetas(db *gorm.DB, opts ...gen.DOOption) coletas {
	...
	_coletas.coletasDo.UseModel(&model.Coletas{})
...
type IColetasDo interface {
	...
	Unscoped() IColetasDo
	Create(values ...*model.Coletas) error
	CreateInBatches(values []*model.Coletas, batchSize int) error
	Save(values ...*model.Coletas) error
	First() (*model.Coletas, error)
	Take() (*model.Coletas, error)
	Last() (*model.Coletas, error)
	Find() ([]*model.Coletas, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Coletas, err error)
	FindInBatches(result *[]*model.Coletas, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Coletas) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.Coletas, error)
	FirstOrCreate() (*model.Coletas, error)
	FindByPage(offset int, limit int) (result []*model.Coletas, count int64, err error)
...
func (c coletasDo) Create(values ...*model.Coletas) error {
	if len(values) == 0 {
		return nil
	}
...
func (c coletasDo) CreateInBatches(values []*model.Coletas, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c coletasDo) Save(values ...*model.Coletas) error {
	if len(values) == 0 {
		return nil
	}
...
func (c coletasDo) First() (*model.Coletas, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.Coletas), nil
	}
}

func (c coletasDo) Take() (*model.Coletas, error) {
...
func (c coletasDo) Last() (*model.Coletas, error) {
...
func (c coletasDo) Find() ([]*model.Coletas, error) {
	result, err := c.DO.Find()
	return result.([]*model.Coletas), err
}

func (c coletasDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Coletas, err error) {
	buf := make([]*model.Coletas, 0, batchSize)
...
func (c coletasDo) FindInBatches(result *[]*model.Coletas, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c coletasDo) FirstOrInit() (*model.Coletas, error) {
...
func (c coletasDo) FirstOrCreate() (*model.Coletas, error) {
...
func (c coletasDo) FindByPage(offset int, limit int) (result []*model.Coletas, count int64, err error) {
...
func (c coletasDo) Delete(models ...*model.Coletas) (result gen.ResultInfo, err error) {
