...
func newUnidadeMedidas(db *gorm.DB, opts ...gen.DOOption) unidadeMedidas {
	...
	_unidadeMedidas.unidadeMedidasDo.UseModel(&model.UnidadeMedidas{})
...
type IUnidadeMedidasDo interface {
	...
	Create(values ...*model.UnidadeMedidas) error
	CreateInBatches(values []*model.UnidadeMedidas, batchSize int) error
	Save(values ...*model.UnidadeMedidas) error
	First() (*model.UnidadeMedidas, error)
	Take() (*model.UnidadeMedidas, error)
	Last() (*model.UnidadeMedidas, error)
	Find() ([]*model.UnidadeMedidas, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.UnidadeMedidas, err error)
	FindInBatches(result *[]*model.UnidadeMedidas, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.UnidadeMedidas) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.UnidadeMedidas, error)
	FirstOrCreate() (*model.UnidadeMedidas, error)
	FindByPage(offset int, limit int) (result []*model.UnidadeMedidas, count int64, err error)
...
func (u unidadeMedidasDo) Create(values ...*model.UnidadeMedidas) error {
	if len(values) == 0 {
		return nil
	}
...
func (u unidadeMedidasDo) CreateInBatches(values []*model.UnidadeMedidas, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u unidadeMedidasDo) Save(values ...*model.UnidadeMedidas) error {
	if len(values) == 0 {
		return nil
	}
...
func (u unidadeMedidasDo) First() (*model.UnidadeMedidas, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.UnidadeMedidas), nil
	}
}

func (u unidadeMedidasDo) Take() (*model.UnidadeMedidas, error) {
...
func (u unidadeMedidasDo) Last() (*model.UnidadeMedidas, error) {
...
func (u unidadeMedidasDo) Find() ([]*model.UnidadeMedidas, error) {
	result, err := u.DO.Find()
	return result.([]*model.UnidadeMedidas), err
}

func (u unidadeMedidasDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.UnidadeMedidas, err error) {
	buf := make([]*model.UnidadeMedidas, 0, batchSize)
...
func (u unidadeMedidasDo) FindInBatches(result *[]*model.UnidadeMedidas, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u unidadeMedidasDo) FirstOrInit() (*model.UnidadeMedidas, error) {
...
func (u unidadeMedidasDo) FirstOrCreate() (*model.UnidadeMedidas, error) {
...
func (u unidadeMedidasDo) FindByPage(offset int, limit int) (result []*model.UnidadeMedidas, count int64, err error) {
...
func (u unidadeMedidasDo) Delete(models ...*model.UnidadeMedidas) (result gen.ResultInfo, err error) {
