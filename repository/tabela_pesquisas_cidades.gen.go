...
func newPesquisasCidades(db *gorm.DB, opts ...gen.DOOption) pesquisasCidades {
	...
	_pesquisasCidades.pesquisasCidadesDo.UseModel(&model.PesquisasCidades{})
...
type IPesquisasCidadesDo interface {
	...
	Create(values ...*model.PesquisasCidades) error
	CreateInBatches(values []*model.PesquisasCidades, batchSize int) error
	Save(values ...*model.PesquisasCidades) error
	First() (*model.PesquisasCidades, error)
	Take() (*model.PesquisasCidades, error)
	Last() (*model.PesquisasCidades, error)
	Find() ([]*model.PesquisasCidades, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.PesquisasCidades, err error)
	FindInBatches(result *[]*model.PesquisasCidades, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.PesquisasCidades) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.PesquisasCidades, error)
	FirstOrCreate() (*model.PesquisasCidades, error)
	FindByPage(offset int, limit int) (result []*model.PesquisasCidades, count int64, err error)
...
func (p pesquisasCidadesDo) Create(values ...*model.PesquisasCidades) error {
	if len(values) == 0 {
		return nil
	}
...
func (p pesquisasCidadesDo) CreateInBatches(values []*model.PesquisasCidades, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p pesquisasCidadesDo) Save(values ...*model.PesquisasCidades) error {
	if len(values) == 0 {
		return nil
	}
...
func (p pesquisasCidadesDo) First() (*model.PesquisasCidades, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.PesquisasCidades), nil
	}
}

func (p pesquisasCidadesDo) Take() (*model.PesquisasCidades, error) {
...
func (p pesquisasCidadesDo) Last() (*model.PesquisasCidades, error) {
...
func (p pesquisasCidadesDo) Find() ([]*model.PesquisasCidades, error) {
	result, err := p.DO.Find()
	return result.([]*model.PesquisasCidades), err
}

func (p pesquisasCidadesDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.PesquisasCidades, err error) {
	buf := make([]*model.PesquisasCidades, 0, batchSize)
...
func (p pesquisasCidadesDo) FindInBatches(result *[]*model.PesquisasCidades, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p pesquisasCidadesDo) FirstOrInit() (*model.PesquisasCidades, error) {
...
func (p pesquisasCidadesDo) FirstOrCreate() (*model.PesquisasCidades, error) {
...
func (p pesquisasCidadesDo) FindByPage(offset int, limit int) (result []*model.PesquisasCidades, count int64, err error) {
...
func (p pesquisasCidadesDo) Delete(models ...*model.PesquisasCidades) (result gen.ResultInfo, err error) {
