...
func newEstabelecimentosSecundarios(db *gorm.DB, opts ...gen.DOOption) estabelecimentosSecundarios {
	...
	_estabelecimentosSecundarios.estabelecimentosSecundariosDo.UseModel(&model.EstabelecimentosSecundarios{})
...
type IEstabelecimentosSecundariosDo interface {
	...
	Create(values ...*model.EstabelecimentosSecundarios) error
	CreateInBatches(values []*model.EstabelecimentosSecundarios, batchSize int) error
	Save(values ...*model.EstabelecimentosSecundarios) error
	First() (*model.EstabelecimentosSecundarios, error)
	Take() (*model.EstabelecimentosSecundarios, error)
	Last() (*model.EstabelecimentosSecundarios, error)
	Find() ([]*model.EstabelecimentosSecundarios, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.EstabelecimentosSecundarios, err error)
	FindInBatches(result *[]*model.EstabelecimentosSecundarios, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.EstabelecimentosSecundarios) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.EstabelecimentosSecundarios, error)
	FirstOrCreate() (*model.EstabelecimentosSecundarios, error)
	FindByPage(offset int, limit int) (result []*model.EstabelecimentosSecundarios, count int64, err error)
...
func (e estabelecimentosSecundariosDo) Create(values ...*model.EstabelecimentosSecundarios) error {
	if len(values) == 0 {
		return nil
	}
...
func (e estabelecimentosSecundariosDo) CreateInBatches(values []*model.EstabelecimentosSecundarios, batchSize int) error {
	return e.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (e estabelecimentosSecundariosDo) Save(values ...*model.EstabelecimentosSecundarios) error {
	if len(values) == 0 {
		return nil
	}
...
func (e estabelecimentosSecundariosDo) First() (*model.EstabelecimentosSecundarios, error) {
	if result, err := e.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.EstabelecimentosSecundarios), nil
	}
}

func (e estabelecimentosSecundariosDo) Take() (*model.EstabelecimentosSecundarios, error) {
...
func (e estabelecimentosSecundariosDo) Last() (*model.EstabelecimentosSecundarios, error) {
...
func (e estabelecimentosSecundariosDo) Find() ([]*model.EstabelecimentosSecundarios, error) {
	result, err := e.DO.Find()
	return result.([]*model.EstabelecimentosSecundarios), err
}

func (e estabelecimentosSecundariosDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.EstabelecimentosSecundarios, err error) {
	buf := make([]*model.EstabelecimentosSecundarios, 0, batchSize)
...
func (e estabelecimentosSecundariosDo) FindInBatches(result *[]*model.EstabelecimentosSecundarios, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (e estabelecimentosSecundariosDo) FirstOrInit() (*model.EstabelecimentosSecundarios, error) {
...
func (e estabelecimentosSecundariosDo) FirstOrCreate() (*model.EstabelecimentosSecundarios, error) {
...
func (e estabelecimentosSecundariosDo) FindByPage(offset int, limit int) (result []*model.EstabelecimentosSecundarios, count int64, err error) {
...
func (e estabelecimentosSecundariosDo) Delete(models ...*model.EstabelecimentosSecundarios) (result gen.ResultInfo, err error) {
