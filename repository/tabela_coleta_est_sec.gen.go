...
func newColetaEstSec(db *gorm.DB, opts ...gen.DOOption) coletaEstSec {
	...
	_coletaEstSec.coletaEstSecDo.UseModel(&model.ColetaEstSec{})
...
type IColetaEstSecDo interface {
	...
	Create(values ...*model.ColetaEstSec) error
	CreateInBatches(values []*model.ColetaEstSec, batchSize int) error
	Save(values ...*model.ColetaEstSec) error
	First() (*model.ColetaEstSec, error)
	Take() (*model.ColetaEstSec, error)
	Last() (*model.ColetaEstSec, error)
	Find() ([]*model.ColetaEstSec, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.ColetaEstSec, err error)
	FindInBatches(result *[]*model.ColetaEstSec, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.ColetaEstSec) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.ColetaEstSec, error)
	FirstOrCreate() (*model.ColetaEstSec, error)
	FindByPage(offset int, limit int) (result []*model.ColetaEstSec, count int64, err error)
...
func (c coletaEstSecDo) Create(values ...*model.ColetaEstSec) error {
	if len(values) == 0 {
		return nil
	}
...
func (c coletaEstSecDo) CreateInBatches(values []*model.ColetaEstSec, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c coletaEstSecDo) Save(values ...*model.ColetaEstSec) error {
	if len(values) == 0 {
		return nil
	}
...
func (c coletaEstSecDo) First() (*model.ColetaEstSec, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.ColetaEstSec), nil
	}
}

func (c coletaEstSecDo) Take() (*model.ColetaEstSec, error) {
...
func (c coletaEstSecDo) Last() (*model.ColetaEstSec, error) {
...
func (c coletaEstSecDo) Find() ([]*model.ColetaEstSec, error) {
	result, err := c.DO.Find()
	return result.([]*model.ColetaEstSec), err
}

func (c coletaEstSecDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.ColetaEstSec, err error) {
	buf := make([]*model.ColetaEstSec, 0, batchSize)
...
func (c coletaEstSecDo) FindInBatches(result *[]*model.ColetaEstSec, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c coletaEstSecDo) FirstOrInit() (*model.ColetaEstSec, error) {
...
func (c coletaEstSecDo) FirstOrCreate() (*model.ColetaEstSec, error) {
...
func (c coletaEstSecDo) FindByPage(offset int, limit int) (result []*model.ColetaEstSec, count int64, err error) {
...
func (c coletaEstSecDo) Delete(models ...*model.ColetaEstSec) (result gen.ResultInfo, err error) {
