...
func newPesquisaResultadosProdutos(db *gorm.DB, opts ...gen.DOOption) pesquisaResultadosProdutos {
	...
	_pesquisaResultadosProdutos.pesquisaResultadosProdutosDo.UseModel(&model.PesquisaResultadosProdutos{})
...
type IPesquisaResultadosProdutosDo interface {
	...
	Create(values ...*model.PesquisaResultadosProdutos) error
	CreateInBatches(values []*model.PesquisaResultadosProdutos, batchSize int) error
	Save(values ...*model.PesquisaResultadosProdutos) error
	First() (*model.PesquisaResultadosProdutos, error)
	Take() (*model.PesquisaResultadosProdutos, error)
	Last() (*model.PesquisaResultadosProdutos, error)
	Find() ([]*model.PesquisaResultadosProdutos, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.PesquisaResultadosProdutos, err error)
	FindInBatches(result *[]*model.PesquisaResultadosProdutos, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.PesquisaResultadosProdutos) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.PesquisaResultadosProdutos, error)
	FirstOrCreate() (*model.PesquisaResultadosProdutos, error)
	FindByPage(offset int, limit int) (result []*model.PesquisaResultadosProdutos, count int64, err error)
...
func (p pesquisaResultadosProdutosDo) Create(values ...*model.PesquisaResultadosProdutos) error {
	if len(values) == 0 {
		return nil
	}
...
func (p pesquisaResultadosProdutosDo) CreateInBatches(values []*model.PesquisaResultadosProdutos, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p pesquisaResultadosProdutosDo) Save(values ...*model.PesquisaResultadosProdutos) error {
	if len(values) == 0 {
		return nil
	}
...
func (p pesquisaResultadosProdutosDo) First() (*model.PesquisaResultadosProdutos, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.PesquisaResultadosProdutos), nil
	}
}

func (p pesquisaResultadosProdutosDo) Take() (*model.PesquisaResultadosProdutos, error) {
...
func (p pesquisaResultadosProdutosDo) Last() (*model.PesquisaResultadosProdutos, error) {
...
func (p pesquisaResultadosProdutosDo) Find() ([]*model.PesquisaResultadosProdutos, error) {
	result, err := p.DO.Find()
	return result.([]*model.PesquisaResultadosProdutos), err
}

func (p pesquisaResultadosProdutosDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.PesquisaResultadosProdutos, err error) {
	buf := make([]*model.PesquisaResultadosProdutos, 0, batchSize)
...
func (p pesquisaResultadosProdutosDo) FindInBatches(result *[]*model.PesquisaResultadosProdutos, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p pesquisaResultadosProdutosDo) FirstOrInit() (*model.PesquisaResultadosProdutos, error) {
...
func (p pesquisaResultadosProdutosDo) FirstOrCreate() (*model.PesquisaResultadosProdutos, error) {
...
func (p pesquisaResultadosProdutosDo) FindByPage(offset int, limit int) (result []*model.PesquisaResultadosProdutos, count int64, err error) {
...
func (p pesquisaResultadosProdutosDo) Delete(models ...*model.PesquisaResultadosProdutos) (result gen.ResultInfo, err error) {
