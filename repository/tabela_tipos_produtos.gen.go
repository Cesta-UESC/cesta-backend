...
func newTiposProdutos(db *gorm.DB, opts ...gen.DOOption) tiposProdutos {
	...
	_tiposProdutos.tiposProdutosDo.UseModel(&model.TiposProdutos{})
...
type ITiposProdutosDo interface {
	...
	Create(values ...*model.TiposProdutos) error
	CreateInBatches(values []*model.TiposProdutos, batchSize int) error
	Save(values ...*model.TiposProdutos) error
	First() (*model.TiposProdutos, error)
	Take() (*model.TiposProdutos, error)
	Last() (*model.TiposProdutos, error)
	Find() ([]*model.TiposProdutos, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.TiposProdutos, err error)
	FindInBatches(result *[]*model.TiposProdutos, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.TiposProdutos) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.TiposProdutos, error)
	FirstOrCreate() (*model.TiposProdutos, error)
	FindByPage(offset int, limit int) (result []*model.TiposProdutos, count int64, err error)
...
func (t tiposProdutosDo) Create(values ...*model.TiposProdutos) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tiposProdutosDo) CreateInBatches(values []*model.TiposProdutos, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tiposProdutosDo) Save(values ...*model.TiposProdutos) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tiposProdutosDo) First() (*model.TiposProdutos, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.TiposProdutos), nil
	}
}

func (t tiposProdutosDo) Take() (*model.TiposProdutos, error) {
...
func (t tiposProdutosDo) Last() (*model.TiposProdutos, error) {
...
func (t tiposProdutosDo) Find() ([]*model.TiposProdutos, error) {
	result, err := t.DO.Find()
	return result.([]*model.TiposProdutos), err
}

func (t tiposProdutosDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.TiposProdutos, err error) {
	buf := make([]*model.TiposProdutos, 0, batchSize)
...
func (t tiposProdutosDo) FindInBatches(result *[]*model.TiposProdutos, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tiposProdutosDo) FirstOrInit() (*model.TiposProdutos, error) {
...
func (t tiposProdutosDo) FirstOrCreate() (*model.TiposProdutos, error) {
...
func (t tiposProdutosDo) FindByPage(offset int, limit int) (result []*model.TiposProdutos, count int64, err error) {
...
func (t tiposProdutosDo) Delete(models ...*model.TiposProdutos) (result gen.ResultInfo, err error) {
