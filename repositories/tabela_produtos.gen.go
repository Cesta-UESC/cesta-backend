...
func newProdutos(db *gorm.DB, opts ...gen.DOOption) produtos {
	...
	_produtos.produtosDo.UseModel(&models.Produtos{})
...
type IProdutosDo interface {
	...
	Create(values ...*models.Produtos) error
	CreateInBatches(values []*models.Produtos, batchSize int) error
	Save(values ...*models.Produtos) error
	First() (*models.Produtos, error)
	Take() (*models.Produtos, error)
	Last() (*models.Produtos, error)
	Find() ([]*models.Produtos, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Produtos, err error)
	FindInBatches(result *[]*models.Produtos, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Produtos) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Produtos, error)
	FirstOrCreate() (*models.Produtos, error)
	FindByPage(offset int, limit int) (result []*models.Produtos, count int64, err error)
...
func (p produtosDo) Create(values ...*models.Produtos) error {
	if len(values) == 0 {
		return nil
	}
...
func (p produtosDo) CreateInBatches(values []*models.Produtos, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p produtosDo) Save(values ...*models.Produtos) error {
	if len(values) == 0 {
		return nil
	}
...
func (p produtosDo) First() (*models.Produtos, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Produtos), nil
	}
}

func (p produtosDo) Take() (*models.Produtos, error) {
...
func (p produtosDo) Last() (*models.Produtos, error) {
...
func (p produtosDo) Find() ([]*models.Produtos, error) {
	result, err := p.DO.Find()
	return result.([]*models.Produtos), err
}

func (p produtosDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Produtos, err error) {
	buf := make([]*models.Produtos, 0, batchSize)
...
func (p produtosDo) FindInBatches(result *[]*models.Produtos, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p produtosDo) FirstOrInit() (*models.Produtos, error) {
...
func (p produtosDo) FirstOrCreate() (*models.Produtos, error) {
...
func (p produtosDo) FindByPage(offset int, limit int) (result []*models.Produtos, count int64, err error) {
...
func (p produtosDo) Delete(models ...*models.Produtos) (result gen.ResultInfo, err error) {
