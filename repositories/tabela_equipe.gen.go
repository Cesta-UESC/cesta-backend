...
func newEquipe(db *gorm.DB, opts ...gen.DOOption) equipe {
	...
	_equipe.equipeDo.UseModel(&models.Equipe{})
...
type IEquipeDo interface {
	...
	Unscoped() IEquipeDo
	Create(values ...*models.Equipe) error
	CreateInBatches(values []*models.Equipe, batchSize int) error
	Save(values ...*models.Equipe) error
	First() (*models.Equipe, error)
	Take() (*models.Equipe, error)
	Last() (*models.Equipe, error)
	Find() ([]*models.Equipe, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Equipe, err error)
	FindInBatches(result *[]*models.Equipe, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Equipe) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Equipe, error)
	FirstOrCreate() (*models.Equipe, error)
	FindByPage(offset int, limit int) (result []*models.Equipe, count int64, err error)
...
func (e equipeDo) Create(values ...*models.Equipe) error {
	if len(values) == 0 {
		return nil
	}
...
func (e equipeDo) CreateInBatches(values []*models.Equipe, batchSize int) error {
	return e.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (e equipeDo) Save(values ...*models.Equipe) error {
	if len(values) == 0 {
		return nil
	}
...
func (e equipeDo) First() (*models.Equipe, error) {
	if result, err := e.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Equipe), nil
	}
}

func (e equipeDo) Take() (*models.Equipe, error) {
...
func (e equipeDo) Last() (*models.Equipe, error) {
...
func (e equipeDo) Find() ([]*models.Equipe, error) {
	result, err := e.DO.Find()
	return result.([]*models.Equipe), err
}

func (e equipeDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Equipe, err error) {
	buf := make([]*models.Equipe, 0, batchSize)
...
func (e equipeDo) FindInBatches(result *[]*models.Equipe, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (e equipeDo) FirstOrInit() (*models.Equipe, error) {
...
func (e equipeDo) FirstOrCreate() (*models.Equipe, error) {
...
func (e equipeDo) FindByPage(offset int, limit int) (result []*models.Equipe, count int64, err error) {
...
func (e equipeDo) Delete(models ...*models.Equipe) (result gen.ResultInfo, err error) {
