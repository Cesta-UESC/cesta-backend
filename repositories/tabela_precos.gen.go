...
func newPrecos(db *gorm.DB, opts ...gen.DOOption) precos {
	...
	_precos.precosDo.UseModel(&models.Precos{})
...
type IPrecosDo interface {
	...
	Unscoped() IPrecosDo
	Create(values ...*models.Precos) error
	CreateInBatches(values []*models.Precos, batchSize int) error
	Save(values ...*models.Precos) error
	First() (*models.Precos, error)
	Take() (*models.Precos, error)
	Last() (*models.Precos, error)
	Find() ([]*models.Precos, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Precos, err error)
	FindInBatches(result *[]*models.Precos, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Precos) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Precos, error)
	FirstOrCreate() (*models.Precos, error)
	FindByPage(offset int, limit int) (result []*models.Precos, count int64, err error)
...
func (p precosDo) Create(values ...*models.Precos) error {
	if len(values) == 0 {
		return nil
	}
...
func (p precosDo) CreateInBatches(values []*models.Precos, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p precosDo) Save(values ...*models.Precos) error {
	if len(values) == 0 {
		return nil
	}
...
func (p precosDo) First() (*models.Precos, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Precos), nil
	}
}

func (p precosDo) Take() (*models.Precos, error) {
...
func (p precosDo) Last() (*models.Precos, error) {
...
func (p precosDo) Find() ([]*models.Precos, error) {
	result, err := p.DO.Find()
	return result.([]*models.Precos), err
}

func (p precosDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Precos, err error) {
	buf := make([]*models.Precos, 0, batchSize)
...
func (p precosDo) FindInBatches(result *[]*models.Precos, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p precosDo) FirstOrInit() (*models.Precos, error) {
...
func (p precosDo) FirstOrCreate() (*models.Precos, error) {
...
func (p precosDo) FindByPage(offset int, limit int) (result []*models.Precos, count int64, err error) {
...
func (p precosDo) Delete(models ...*models.Precos) (result gen.ResultInfo, err error) {
