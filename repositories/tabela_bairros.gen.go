...
func newBairros(db *gorm.DB, opts ...gen.DOOption) bairros {
	...
	_bairros.bairrosDo.UseModel(&models.Bairros{})
...
type IBairrosDo interface {
	...
	Unscoped() IBairrosDo
	Create(values ...*models.Bairros) error
	CreateInBatches(values []*models.Bairros, batchSize int) error
	Save(values ...*models.Bairros) error
	First() (*models.Bairros, error)
	Take() (*models.Bairros, error)
	Last() (*models.Bairros, error)
	Find() ([]*models.Bairros, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Bairros, err error)
	FindInBatches(result *[]*models.Bairros, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Bairros) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Bairros, error)
	FirstOrCreate() (*models.Bairros, error)
	FindByPage(offset int, limit int) (result []*models.Bairros, count int64, err error)
...
func (b bairrosDo) Create(values ...*models.Bairros) error {
	if len(values) == 0 {
		return nil
	}
...
func (b bairrosDo) CreateInBatches(values []*models.Bairros, batchSize int) error {
	return b.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (b bairrosDo) Save(values ...*models.Bairros) error {
	if len(values) == 0 {
		return nil
	}
...
func (b bairrosDo) First() (*models.Bairros, error) {
	if result, err := b.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Bairros), nil
	}
}

func (b bairrosDo) Take() (*models.Bairros, error) {
...
func (b bairrosDo) Last() (*models.Bairros, error) {
...
func (b bairrosDo) Find() ([]*models.Bairros, error) {
	result, err := b.DO.Find()
	return result.([]*models.Bairros), err
}

func (b bairrosDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Bairros, err error) {
	buf := make([]*models.Bairros, 0, batchSize)
...
func (b bairrosDo) FindInBatches(result *[]*models.Bairros, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (b bairrosDo) FirstOrInit() (*models.Bairros, error) {
...
func (b bairrosDo) FirstOrCreate() (*models.Bairros, error) {
...
func (b bairrosDo) FindByPage(offset int, limit int) (result []*models.Bairros, count int64, err error) {
...
func (b bairrosDo) Delete(models ...*models.Bairros) (result gen.ResultInfo, err error) {
