...
func newEquipeFuncoes(db *gorm.DB, opts ...gen.DOOption) equipeFuncoes {
	...
	_equipeFuncoes.equipeFuncoesDo.UseModel(&models.EquipeFuncoes{})
...
type IEquipeFuncoesDo interface {
	...
	Create(values ...*models.EquipeFuncoes) error
	CreateInBatches(values []*models.EquipeFuncoes, batchSize int) error
	Save(values ...*models.EquipeFuncoes) error
	First() (*models.EquipeFuncoes, error)
	Take() (*models.EquipeFuncoes, error)
	Last() (*models.EquipeFuncoes, error)
	Find() ([]*models.EquipeFuncoes, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.EquipeFuncoes, err error)
	FindInBatches(result *[]*models.EquipeFuncoes, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.EquipeFuncoes) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.EquipeFuncoes, error)
	FirstOrCreate() (*models.EquipeFuncoes, error)
	FindByPage(offset int, limit int) (result []*models.EquipeFuncoes, count int64, err error)
...
func (e equipeFuncoesDo) Create(values ...*models.EquipeFuncoes) error {
	if len(values) == 0 {
		return nil
	}
...
func (e equipeFuncoesDo) CreateInBatches(values []*models.EquipeFuncoes, batchSize int) error {
	return e.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (e equipeFuncoesDo) Save(values ...*models.EquipeFuncoes) error {
	if len(values) == 0 {
		return nil
	}
...
func (e equipeFuncoesDo) First() (*models.EquipeFuncoes, error) {
	if result, err := e.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.EquipeFuncoes), nil
	}
}

func (e equipeFuncoesDo) Take() (*models.EquipeFuncoes, error) {
...
func (e equipeFuncoesDo) Last() (*models.EquipeFuncoes, error) {
...
func (e equipeFuncoesDo) Find() ([]*models.EquipeFuncoes, error) {
	result, err := e.DO.Find()
	return result.([]*models.EquipeFuncoes), err
}

func (e equipeFuncoesDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.EquipeFuncoes, err error) {
	buf := make([]*models.EquipeFuncoes, 0, batchSize)
...
func (e equipeFuncoesDo) FindInBatches(result *[]*models.EquipeFuncoes, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (e equipeFuncoesDo) FirstOrInit() (*models.EquipeFuncoes, error) {
...
func (e equipeFuncoesDo) FirstOrCreate() (*models.EquipeFuncoes, error) {
...
func (e equipeFuncoesDo) FindByPage(offset int, limit int) (result []*models.EquipeFuncoes, count int64, err error) {
...
func (e equipeFuncoesDo) Delete(models ...*models.EquipeFuncoes) (result gen.ResultInfo, err error) {
