...
func newUsuarios(db *gorm.DB, opts ...gen.DOOption) usuarios {
	...
	_usuarios.usuariosDo.UseModel(&models.Usuarios{})
...
type IUsuariosDo interface {
	...
	Create(values ...*models.Usuarios) error
	CreateInBatches(values []*models.Usuarios, batchSize int) error
	Save(values ...*models.Usuarios) error
	First() (*models.Usuarios, error)
	Take() (*models.Usuarios, error)
	Last() (*models.Usuarios, error)
	Find() ([]*models.Usuarios, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Usuarios, err error)
	FindInBatches(result *[]*models.Usuarios, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Usuarios) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Usuarios, error)
	FirstOrCreate() (*models.Usuarios, error)
	FindByPage(offset int, limit int) (result []*models.Usuarios, count int64, err error)
...
func (u usuariosDo) Create(values ...*models.Usuarios) error {
	if len(values) == 0 {
		return nil
	}
...
func (u usuariosDo) CreateInBatches(values []*models.Usuarios, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u usuariosDo) Save(values ...*models.Usuarios) error {
	if len(values) == 0 {
		return nil
	}
...
func (u usuariosDo) First() (*models.Usuarios, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Usuarios), nil
	}
}

func (u usuariosDo) Take() (*models.Usuarios, error) {
...
func (u usuariosDo) Last() (*models.Usuarios, error) {
...
func (u usuariosDo) Find() ([]*models.Usuarios, error) {
	result, err := u.DO.Find()
	return result.([]*models.Usuarios), err
}

func (u usuariosDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Usuarios, err error) {
	buf := make([]*models.Usuarios, 0, batchSize)
...
func (u usuariosDo) FindInBatches(result *[]*models.Usuarios, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u usuariosDo) FirstOrInit() (*models.Usuarios, error) {
...
func (u usuariosDo) FirstOrCreate() (*models.Usuarios, error) {
...
func (u usuariosDo) FindByPage(offset int, limit int) (result []*models.Usuarios, count int64, err error) {
...
func (u usuariosDo) Delete(models ...*models.Usuarios) (result gen.ResultInfo, err error) {
