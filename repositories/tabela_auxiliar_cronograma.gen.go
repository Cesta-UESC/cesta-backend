...
func newAuxiliarCronograma(db *gorm.DB, opts ...gen.DOOption) auxiliarCronograma {
	...
	_auxiliarCronograma.auxiliarCronogramaDo.UseModel(&models.AuxiliarCronograma{})
...
type IAuxiliarCronogramaDo interface {
	...
	Create(values ...*models.AuxiliarCronograma) error
	CreateInBatches(values []*models.AuxiliarCronograma, batchSize int) error
	Save(values ...*models.AuxiliarCronograma) error
	First() (*models.AuxiliarCronograma, error)
	Take() (*models.AuxiliarCronograma, error)
	Last() (*models.AuxiliarCronograma, error)
	Find() ([]*models.AuxiliarCronograma, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.AuxiliarCronograma, err error)
	FindInBatches(result *[]*models.AuxiliarCronograma, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.AuxiliarCronograma) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.AuxiliarCronograma, error)
	FirstOrCreate() (*models.AuxiliarCronograma, error)
	FindByPage(offset int, limit int) (result []*models.AuxiliarCronograma, count int64, err error)
...
func (a auxiliarCronogramaDo) Create(values ...*models.AuxiliarCronograma) error {
	if len(values) == 0 {
		return nil
	}
...
func (a auxiliarCronogramaDo) CreateInBatches(values []*models.AuxiliarCronograma, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a auxiliarCronogramaDo) Save(values ...*models.AuxiliarCronograma) error {
	if len(values) == 0 {
		return nil
	}
...
func (a auxiliarCronogramaDo) First() (*models.AuxiliarCronograma, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.AuxiliarCronograma), nil
	}
}

func (a auxiliarCronogramaDo) Take() (*models.AuxiliarCronograma, error) {
...
func (a auxiliarCronogramaDo) Last() (*models.AuxiliarCronograma, error) {
...
func (a auxiliarCronogramaDo) Find() ([]*models.AuxiliarCronograma, error) {
	result, err := a.DO.Find()
	return result.([]*models.AuxiliarCronograma), err
}

func (a auxiliarCronogramaDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.AuxiliarCronograma, err error) {
	buf := make([]*models.AuxiliarCronograma, 0, batchSize)
...
func (a auxiliarCronogramaDo) FindInBatches(result *[]*models.AuxiliarCronograma, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a auxiliarCronogramaDo) FirstOrInit() (*models.AuxiliarCronograma, error) {
...
func (a auxiliarCronogramaDo) FirstOrCreate() (*models.AuxiliarCronograma, error) {
...
func (a auxiliarCronogramaDo) FindByPage(offset int, limit int) (result []*models.AuxiliarCronograma, count int64, err error) {
...
func (a auxiliarCronogramaDo) Delete(models ...*models.AuxiliarCronograma) (result gen.ResultInfo, err error) {
