...
func newSalarios(db *gorm.DB, opts ...gen.DOOption) salarios {
	...
	_salarios.salariosDo.UseModel(&models.Salarios{})
...
type ISalariosDo interface {
	...
	Create(values ...*models.Salarios) error
	CreateInBatches(values []*models.Salarios, batchSize int) error
	Save(values ...*models.Salarios) error
	First() (*models.Salarios, error)
	Take() (*models.Salarios, error)
	Last() (*models.Salarios, error)
	Find() ([]*models.Salarios, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Salarios, err error)
	FindInBatches(result *[]*models.Salarios, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Salarios) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Salarios, error)
	FirstOrCreate() (*models.Salarios, error)
	FindByPage(offset int, limit int) (result []*models.Salarios, count int64, err error)
...
func (s salariosDo) Create(values ...*models.Salarios) error {
	if len(values) == 0 {
		return nil
	}
...
func (s salariosDo) CreateInBatches(values []*models.Salarios, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s salariosDo) Save(values ...*models.Salarios) error {
	if len(values) == 0 {
		return nil
	}
...
func (s salariosDo) First() (*models.Salarios, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Salarios), nil
	}
}

func (s salariosDo) Take() (*models.Salarios, error) {
...
func (s salariosDo) Last() (*models.Salarios, error) {
...
func (s salariosDo) Find() ([]*models.Salarios, error) {
	result, err := s.DO.Find()
	return result.([]*models.Salarios), err
}

func (s salariosDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Salarios, err error) {
	buf := make([]*models.Salarios, 0, batchSize)
...
func (s salariosDo) FindInBatches(result *[]*models.Salarios, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s salariosDo) FirstOrInit() (*models.Salarios, error) {
...
func (s salariosDo) FirstOrCreate() (*models.Salarios, error) {
...
func (s salariosDo) FindByPage(offset int, limit int) (result []*models.Salarios, count int64, err error) {
...
func (s salariosDo) Delete(models ...*models.Salarios) (result gen.ResultInfo, err error) {
