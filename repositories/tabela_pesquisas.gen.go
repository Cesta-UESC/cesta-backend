...
func newPesquisas(db *gorm.DB, opts ...gen.DOOption) pesquisas {
	...
	_pesquisas.pesquisasDo.UseModel(&models.Pesquisas{})
...
type IPesquisasDo interface {
	...
	Create(values ...*models.Pesquisas) error
	CreateInBatches(values []*models.Pesquisas, batchSize int) error
	Save(values ...*models.Pesquisas) error
	First() (*models.Pesquisas, error)
	Take() (*models.Pesquisas, error)
	Last() (*models.Pesquisas, error)
	Find() ([]*models.Pesquisas, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Pesquisas, err error)
	FindInBatches(result *[]*models.Pesquisas, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Pesquisas) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Pesquisas, error)
	FirstOrCreate() (*models.Pesquisas, error)
	FindByPage(offset int, limit int) (result []*models.Pesquisas, count int64, err error)
...
func (p pesquisasDo) Create(values ...*models.Pesquisas) error {
	if len(values) == 0 {
		return nil
	}
...
func (p pesquisasDo) CreateInBatches(values []*models.Pesquisas, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p pesquisasDo) Save(values ...*models.Pesquisas) error {
	if len(values) == 0 {
		return nil
	}
...
func (p pesquisasDo) First() (*models.Pesquisas, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Pesquisas), nil
	}
}

func (p pesquisasDo) Take() (*models.Pesquisas, error) {
...
func (p pesquisasDo) Last() (*models.Pesquisas, error) {
...
func (p pesquisasDo) Find() ([]*models.Pesquisas, error) {
	result, err := p.DO.Find()
	return result.([]*models.Pesquisas), err
}

func (p pesquisasDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Pesquisas, err error) {
	buf := make([]*models.Pesquisas, 0, batchSize)
...
func (p pesquisasDo) FindInBatches(result *[]*models.Pesquisas, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p pesquisasDo) FirstOrInit() (*models.Pesquisas, error) {
...
func (p pesquisasDo) FirstOrCreate() (*models.Pesquisas, error) {
...
func (p pesquisasDo) FindByPage(offset int, limit int) (result []*models.Pesquisas, count int64, err error) {
...
func (p pesquisasDo) Delete(models ...*models.Pesquisas) (result gen.ResultInfo, err error) {
