...
func newProdutosMedidas(db *gorm.DB, opts ...gen.DOOption) produtosMedidas {
	...
	_produtosMedidas.produtosMedidasDo.UseModel(&models.ProdutosMedidas{})
...
type IProdutosMedidasDo interface {
	...
	Create(values ...*models.ProdutosMedidas) error
	CreateInBatches(values []*models.ProdutosMedidas, batchSize int) error
	Save(values ...*models.ProdutosMedidas) error
	First() (*models.ProdutosMedidas, error)
	Take() (*models.ProdutosMedidas, error)
	Last() (*models.ProdutosMedidas, error)
	Find() ([]*models.ProdutosMedidas, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.ProdutosMedidas, err error)
	FindInBatches(result *[]*models.ProdutosMedidas, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.ProdutosMedidas) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.ProdutosMedidas, error)
	FirstOrCreate() (*models.ProdutosMedidas, error)
	FindByPage(offset int, limit int) (result []*models.ProdutosMedidas, count int64, err error)
...
func (p produtosMedidasDo) Create(values ...*models.ProdutosMedidas) error {
	if len(values) == 0 {
		return nil
	}
...
func (p produtosMedidasDo) CreateInBatches(values []*models.ProdutosMedidas, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p produtosMedidasDo) Save(values ...*models.ProdutosMedidas) error {
	if len(values) == 0 {
		return nil
	}
...
func (p produtosMedidasDo) First() (*models.ProdutosMedidas, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.ProdutosMedidas), nil
	}
}

func (p produtosMedidasDo) Take() (*models.ProdutosMedidas, error) {
...
func (p produtosMedidasDo) Last() (*models.ProdutosMedidas, error) {
...
func (p produtosMedidasDo) Find() ([]*models.ProdutosMedidas, error) {
	result, err := p.DO.Find()
	return result.([]*models.ProdutosMedidas), err
}

func (p produtosMedidasDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.ProdutosMedidas, err error) {
	buf := make([]*models.ProdutosMedidas, 0, batchSize)
...
func (p produtosMedidasDo) FindInBatches(result *[]*models.ProdutosMedidas, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p produtosMedidasDo) FirstOrInit() (*models.ProdutosMedidas, error) {
...
func (p produtosMedidasDo) FirstOrCreate() (*models.ProdutosMedidas, error) {
...
func (p produtosMedidasDo) FindByPage(offset int, limit int) (result []*models.ProdutosMedidas, count int64, err error) {
...
func (p produtosMedidasDo) Delete(models ...*models.ProdutosMedidas) (result gen.ResultInfo, err error) {
