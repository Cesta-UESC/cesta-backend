...
func newCronogramaColetas(db *gorm.DB, opts ...gen.DOOption) cronogramaColetas {
	...
	_cronogramaColetas.cronogramaColetasDo.UseModel(&models.CronogramaColetas{})
...
type ICronogramaColetasDo interface {
	...
	Create(values ...*models.CronogramaColetas) error
	CreateInBatches(values []*models.CronogramaColetas, batchSize int) error
	Save(values ...*models.CronogramaColetas) error
	First() (*models.CronogramaColetas, error)
	Take() (*models.CronogramaColetas, error)
	Last() (*models.CronogramaColetas, error)
	Find() ([]*models.CronogramaColetas, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.CronogramaColetas, err error)
	FindInBatches(result *[]*models.CronogramaColetas, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.CronogramaColetas) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.CronogramaColetas, error)
	FirstOrCreate() (*models.CronogramaColetas, error)
	FindByPage(offset int, limit int) (result []*models.CronogramaColetas, count int64, err error)
...
func (c cronogramaColetasDo) Create(values ...*models.CronogramaColetas) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cronogramaColetasDo) CreateInBatches(values []*models.CronogramaColetas, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c cronogramaColetasDo) Save(values ...*models.CronogramaColetas) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cronogramaColetasDo) First() (*models.CronogramaColetas, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.CronogramaColetas), nil
	}
}

func (c cronogramaColetasDo) Take() (*models.CronogramaColetas, error) {
...
func (c cronogramaColetasDo) Last() (*models.CronogramaColetas, error) {
...
func (c cronogramaColetasDo) Find() ([]*models.CronogramaColetas, error) {
	result, err := c.DO.Find()
	return result.([]*models.CronogramaColetas), err
}

func (c cronogramaColetasDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.CronogramaColetas, err error) {
	buf := make([]*models.CronogramaColetas, 0, batchSize)
...
func (c cronogramaColetasDo) FindInBatches(result *[]*models.CronogramaColetas, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c cronogramaColetasDo) FirstOrInit() (*models.CronogramaColetas, error) {
...
func (c cronogramaColetasDo) FirstOrCreate() (*models.CronogramaColetas, error) {
...
func (c cronogramaColetasDo) FindByPage(offset int, limit int) (result []*models.CronogramaColetas, count int64, err error) {
...
func (c cronogramaColetasDo) Delete(models ...*models.CronogramaColetas) (result gen.ResultInfo, err error) {
