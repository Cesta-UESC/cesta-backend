...
func newEstabelecimentoHasSecundario(db *gorm.DB, opts ...gen.DOOption) estabelecimentoHasSecundario {
	...
	_estabelecimentoHasSecundario.estabelecimentoHasSecundarioDo.UseModel(&models.EstabelecimentoHasSecundario{})
...
type IEstabelecimentoHasSecundarioDo interface {
	...
	Create(values ...*models.EstabelecimentoHasSecundario) error
	CreateInBatches(values []*models.EstabelecimentoHasSecundario, batchSize int) error
	Save(values ...*models.EstabelecimentoHasSecundario) error
	First() (*models.EstabelecimentoHasSecundario, error)
	Take() (*models.EstabelecimentoHasSecundario, error)
	Last() (*models.EstabelecimentoHasSecundario, error)
	Find() ([]*models.EstabelecimentoHasSecundario, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.EstabelecimentoHasSecundario, err error)
	FindInBatches(result *[]*models.EstabelecimentoHasSecundario, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.EstabelecimentoHasSecundario) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.EstabelecimentoHasSecundario, error)
	FirstOrCreate() (*models.EstabelecimentoHasSecundario, error)
	FindByPage(offset int, limit int) (result []*models.EstabelecimentoHasSecundario, count int64, err error)
...
func (e estabelecimentoHasSecundarioDo) Create(values ...*models.EstabelecimentoHasSecundario) error {
	if len(values) == 0 {
		return nil
	}
...
func (e estabelecimentoHasSecundarioDo) CreateInBatches(values []*models.EstabelecimentoHasSecundario, batchSize int) error {
	return e.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (e estabelecimentoHasSecundarioDo) Save(values ...*models.EstabelecimentoHasSecundario) error {
	if len(values) == 0 {
		return nil
	}
...
func (e estabelecimentoHasSecundarioDo) First() (*models.EstabelecimentoHasSecundario, error) {
	if result, err := e.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.EstabelecimentoHasSecundario), nil
	}
}

func (e estabelecimentoHasSecundarioDo) Take() (*models.EstabelecimentoHasSecundario, error) {
...
func (e estabelecimentoHasSecundarioDo) Last() (*models.EstabelecimentoHasSecundario, error) {
...
func (e estabelecimentoHasSecundarioDo) Find() ([]*models.EstabelecimentoHasSecundario, error) {
	result, err := e.DO.Find()
	return result.([]*models.EstabelecimentoHasSecundario), err
}

func (e estabelecimentoHasSecundarioDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.EstabelecimentoHasSecundario, err error) {
	buf := make([]*models.EstabelecimentoHasSecundario, 0, batchSize)
...
func (e estabelecimentoHasSecundarioDo) FindInBatches(result *[]*models.EstabelecimentoHasSecundario, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (e estabelecimentoHasSecundarioDo) FirstOrInit() (*models.EstabelecimentoHasSecundario, error) {
...
func (e estabelecimentoHasSecundarioDo) FirstOrCreate() (*models.EstabelecimentoHasSecundario, error) {
...
func (e estabelecimentoHasSecundarioDo) FindByPage(offset int, limit int) (result []*models.EstabelecimentoHasSecundario, count int64, err error) {
...
func (e estabelecimentoHasSecundarioDo) Delete(models ...*models.EstabelecimentoHasSecundario) (result gen.ResultInfo, err error) {
