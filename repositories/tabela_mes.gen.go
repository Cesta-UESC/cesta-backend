...
func newMes(db *gorm.DB, opts ...gen.DOOption) mes {
	...
	_mes.mesDo.UseModel(&models.Mes{})
...
type IMesDo interface {
	...
	Unscoped() IMesDo
	Create(values ...*models.Mes) error
	CreateInBatches(values []*models.Mes, batchSize int) error
	Save(values ...*models.Mes) error
	First() (*models.Mes, error)
	Take() (*models.Mes, error)
	Last() (*models.Mes, error)
	Find() ([]*models.Mes, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Mes, err error)
	FindInBatches(result *[]*models.Mes, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Mes) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Mes, error)
	FirstOrCreate() (*models.Mes, error)
	FindByPage(offset int, limit int) (result []*models.Mes, count int64, err error)
...
func (m mesDo) Create(values ...*models.Mes) error {
	if len(values) == 0 {
		return nil
	}
...
func (m mesDo) CreateInBatches(values []*models.Mes, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m mesDo) Save(values ...*models.Mes) error {
	if len(values) == 0 {
		return nil
	}
...
func (m mesDo) First() (*models.Mes, error) {
	if result, err := m.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Mes), nil
	}
}

func (m mesDo) Take() (*models.Mes, error) {
...
func (m mesDo) Last() (*models.Mes, error) {
...
func (m mesDo) Find() ([]*models.Mes, error) {
	result, err := m.DO.Find()
	return result.([]*models.Mes), err
}

func (m mesDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Mes, err error) {
	buf := make([]*models.Mes, 0, batchSize)
...
func (m mesDo) FindInBatches(result *[]*models.Mes, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m mesDo) FirstOrInit() (*models.Mes, error) {
...
func (m mesDo) FirstOrCreate() (*models.Mes, error) {
...
func (m mesDo) FindByPage(offset int, limit int) (result []*models.Mes, count int64, err error) {
...
func (m mesDo) Delete(models ...*models.Mes) (result gen.ResultInfo, err error) {
