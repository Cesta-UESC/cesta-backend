...
func newEstabelecimentos(db *gorm.DB, opts ...gen.DOOption) estabelecimentos {
	...
	_estabelecimentos.estabelecimentosDo.UseModel(&models.Estabelecimentos{})
...
type IEstabelecimentosDo interface {
	...
	Create(values ...*models.Estabelecimentos) error
	CreateInBatches(values []*models.Estabelecimentos, batchSize int) error
	Save(values ...*models.Estabelecimentos) error
	First() (*models.Estabelecimentos, error)
	Take() (*models.Estabelecimentos, error)
	Last() (*models.Estabelecimentos, error)
	Find() ([]*models.Estabelecimentos, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Estabelecimentos, err error)
	FindInBatches(result *[]*models.Estabelecimentos, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Estabelecimentos) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Estabelecimentos, error)
	FirstOrCreate() (*models.Estabelecimentos, error)
	FindByPage(offset int, limit int) (result []*models.Estabelecimentos, count int64, err error)
...
func (e estabelecimentosDo) Create(values ...*models.Estabelecimentos) error {
	if len(values) == 0 {
		return nil
	}
...
func (e estabelecimentosDo) CreateInBatches(values []*models.Estabelecimentos, batchSize int) error {
	return e.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (e estabelecimentosDo) Save(values ...*models.Estabelecimentos) error {
	if len(values) == 0 {
		return nil
	}
...
func (e estabelecimentosDo) First() (*models.Estabelecimentos, error) {
	if result, err := e.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Estabelecimentos), nil
	}
}

func (e estabelecimentosDo) Take() (*models.Estabelecimentos, error) {
...
func (e estabelecimentosDo) Last() (*models.Estabelecimentos, error) {
...
func (e estabelecimentosDo) Find() ([]*models.Estabelecimentos, error) {
	result, err := e.DO.Find()
	return result.([]*models.Estabelecimentos), err
}

func (e estabelecimentosDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Estabelecimentos, err error) {
	buf := make([]*models.Estabelecimentos, 0, batchSize)
...
func (e estabelecimentosDo) FindInBatches(result *[]*models.Estabelecimentos, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (e estabelecimentosDo) FirstOrInit() (*models.Estabelecimentos, error) {
...
func (e estabelecimentosDo) FirstOrCreate() (*models.Estabelecimentos, error) {
...
func (e estabelecimentosDo) FindByPage(offset int, limit int) (result []*models.Estabelecimentos, count int64, err error) {
...
func (e estabelecimentosDo) Delete(models ...*models.Estabelecimentos) (result gen.ResultInfo, err error) {
