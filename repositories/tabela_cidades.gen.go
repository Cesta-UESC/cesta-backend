...
func newCidades(db *gorm.DB, opts ...gen.DOOption) cidades {
	...
	_cidades.cidadesDo.UseModel(&models.Cidades{})
...
type ICidadesDo interface {
	...
	Unscoped() ICidadesDo
	Create(values ...*models.Cidades) error
	CreateInBatches(values []*models.Cidades, batchSize int) error
	Save(values ...*models.Cidades) error
	First() (*models.Cidades, error)
	Take() (*models.Cidades, error)
	Last() (*models.Cidades, error)
	Find() ([]*models.Cidades, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Cidades, err error)
	FindInBatches(result *[]*models.Cidades, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Cidades) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Cidades, error)
	FirstOrCreate() (*models.Cidades, error)
	FindByPage(offset int, limit int) (result []*models.Cidades, count int64, err error)
...
func (c cidadesDo) Create(values ...*models.Cidades) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cidadesDo) CreateInBatches(values []*models.Cidades, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c cidadesDo) Save(values ...*models.Cidades) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cidadesDo) First() (*models.Cidades, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Cidades), nil
	}
}

func (c cidadesDo) Take() (*models.Cidades, error) {
...
func (c cidadesDo) Last() (*models.Cidades, error) {
...
func (c cidadesDo) Find() ([]*models.Cidades, error) {
	result, err := c.DO.Find()
	return result.([]*models.Cidades), err
}

func (c cidadesDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Cidades, err error) {
	buf := make([]*models.Cidades, 0, batchSize)
...
func (c cidadesDo) FindInBatches(result *[]*models.Cidades, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c cidadesDo) FirstOrInit() (*models.Cidades, error) {
...
func (c cidadesDo) FirstOrCreate() (*models.Cidades, error) {
...
func (c cidadesDo) FindByPage(offset int, limit int) (result []*models.Cidades, count int64, err error) {
...
func (c cidadesDo) Delete(models ...*models.Cidades) (result gen.ResultInfo, err error) {
