...
func newSessao(db *gorm.DB, opts ...gen.DOOption) sessao {
	...
	_sessao.sessaoDo.UseModel(&models.Sessao{})
...
type ISessaoDo interface {
	...
	Unscoped() ISessaoDo
	Create(values ...*models.Sessao) error
	CreateInBatches(values []*models.Sessao, batchSize int) error
	Save(values ...*models.Sessao) error
	First() (*models.Sessao, error)
	Take() (*models.Sessao, error)
	Last() (*models.Sessao, error)
	Find() ([]*models.Sessao, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Sessao, err error)
	FindInBatches(result *[]*models.Sessao, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Sessao) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Sessao, error)
	FirstOrCreate() (*models.Sessao, error)
	FindByPage(offset int, limit int) (result []*models.Sessao, count int64, err error)
...
func (s sessaoDo) Create(values ...*models.Sessao) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sessaoDo) CreateInBatches(values []*models.Sessao, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sessaoDo) Save(values ...*models.Sessao) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sessaoDo) First() (*models.Sessao, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Sessao), nil
	}
}

func (s sessaoDo) Take() (*models.Sessao, error) {
...
func (s sessaoDo) Last() (*models.Sessao, error) {
...
func (s sessaoDo) Find() ([]*models.Sessao, error) {
	result, err := s.DO.Find()
	return result.([]*models.Sessao), err
}

func (s sessaoDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Sessao, err error) {
	buf := make([]*models.Sessao, 0, batchSize)
...
func (s sessaoDo) FindInBatches(result *[]*models.Sessao, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sessaoDo) FirstOrInit() (*models.Sessao, error) {
...
func (s sessaoDo) FirstOrCreate() (*models.Sessao, error) {
...
func (s sessaoDo) FindByPage(offset int, limit int) (result []*models.Sessao, count int64, err error) {
...
func (s sessaoDo) Delete(models ...*models.Sessao) (result gen.ResultInfo, err error) {
