...
func newBoletim(db *gorm.DB, opts ...gen.DOOption) boletim {
	...
	_boletim.boletimDo.UseModel(&models.Boletim{})
...
type IBoletimDo interface {
	...
	Unscoped() IBoletimDo
	Create(values ...*models.Boletim) error
	CreateInBatches(values []*models.Boletim, batchSize int) error
	Save(values ...*models.Boletim) error
	First() (*models.Boletim, error)
	Take() (*models.Boletim, error)
	Last() (*models.Boletim, error)
	Find() ([]*models.Boletim, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Boletim, err error)
	FindInBatches(result *[]*models.Boletim, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Boletim) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Boletim, error)
	FirstOrCreate() (*models.Boletim, error)
	FindByPage(offset int, limit int) (result []*models.Boletim, count int64, err error)
...
func (b boletimDo) Create(values ...*models.Boletim) error {
	if len(values) == 0 {
		return nil
	}
...
func (b boletimDo) CreateInBatches(values []*models.Boletim, batchSize int) error {
	return b.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (b boletimDo) Save(values ...*models.Boletim) error {
	if len(values) == 0 {
		return nil
	}
...
func (b boletimDo) First() (*models.Boletim, error) {
	if result, err := b.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Boletim), nil
	}
}

func (b boletimDo) Take() (*models.Boletim, error) {
...
func (b boletimDo) Last() (*models.Boletim, error) {
...
func (b boletimDo) Find() ([]*models.Boletim, error) {
	result, err := b.DO.Find()
	return result.([]*models.Boletim), err
}

func (b boletimDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Boletim, err error) {
	buf := make([]*models.Boletim, 0, batchSize)
...
func (b boletimDo) FindInBatches(result *[]*models.Boletim, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (b boletimDo) FirstOrInit() (*models.Boletim, error) {
...
func (b boletimDo) FirstOrCreate() (*models.Boletim, error) {
...
func (b boletimDo) FindByPage(offset int, limit int) (result []*models.Boletim, count int64, err error) {
...
func (b boletimDo) Delete(models ...*models.Boletim) (result gen.ResultInfo, err error) {
