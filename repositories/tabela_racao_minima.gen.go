...
func newRacaoMinima(db *gorm.DB, opts ...gen.DOOption) racaoMinima {
	...
	_racaoMinima.racaoMinimaDo.UseModel(&models.RacaoMinima{})
...
type IRacaoMinimaDo interface {
	...
	Create(values ...*models.RacaoMinima) error
	CreateInBatches(values []*models.RacaoMinima, batchSize int) error
	Save(values ...*models.RacaoMinima) error
	First() (*models.RacaoMinima, error)
	Take() (*models.RacaoMinima, error)
	Last() (*models.RacaoMinima, error)
	Find() ([]*models.RacaoMinima, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.RacaoMinima, err error)
	FindInBatches(result *[]*models.RacaoMinima, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.RacaoMinima) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.RacaoMinima, error)
	FirstOrCreate() (*models.RacaoMinima, error)
	FindByPage(offset int, limit int) (result []*models.RacaoMinima, count int64, err error)
...
func (r racaoMinimaDo) Create(values ...*models.RacaoMinima) error {
	if len(values) == 0 {
		return nil
	}
...
func (r racaoMinimaDo) CreateInBatches(values []*models.RacaoMinima, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r racaoMinimaDo) Save(values ...*models.RacaoMinima) error {
	if len(values) == 0 {
		return nil
	}
...
func (r racaoMinimaDo) First() (*models.RacaoMinima, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.RacaoMinima), nil
	}
}

func (r racaoMinimaDo) Take() (*models.RacaoMinima, error) {
...
func (r racaoMinimaDo) Last() (*models.RacaoMinima, error) {
...
func (r racaoMinimaDo) Find() ([]*models.RacaoMinima, error) {
	result, err := r.DO.Find()
	return result.([]*models.RacaoMinima), err
}

func (r racaoMinimaDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.RacaoMinima, err error) {
	buf := make([]*models.RacaoMinima, 0, batchSize)
...
func (r racaoMinimaDo) FindInBatches(result *[]*models.RacaoMinima, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r racaoMinimaDo) FirstOrInit() (*models.RacaoMinima, error) {
...
func (r racaoMinimaDo) FirstOrCreate() (*models.RacaoMinima, error) {
...
func (r racaoMinimaDo) FindByPage(offset int, limit int) (result []*models.RacaoMinima, count int64, err error) {
...
func (r racaoMinimaDo) Delete(models ...*models.RacaoMinima) (result gen.ResultInfo, err error) {
